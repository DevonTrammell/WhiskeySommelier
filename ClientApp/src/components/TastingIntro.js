...
import backgroundImage from '../img/Background/BkIntro.png';
...
export class TastingIntro extends Component {
    ...
    render() {
        return (
                ...
                <h2 class="homeh2"> Terminology </h2>
                ...
                <h2 class="homeh2"> Whiskey Selection </h2>
                ...
                <h2 class="homeh2"> Tasting Notes</h2>
                ...
                <h2 class="homeh2"> Flavor and Nose Samples </h2>
                ...
                <h2 class="homeh2"> Distilling Insights </h2>
